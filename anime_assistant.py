...
DESKRIPSI: Modul Asisten Anime menggunakan kode SVG murni (Dibuat otomatis oleh kode).
================================================================================
"""
...
def tampilkan_asisten(bot_state):
    """
    Fungsi ini menggambar karakter 'Eagle-Chan' menggunakan titik kordinat SVG
    dan menampilkan teks evaluasi kinerja bot.
    """
    st.markdown("---")
...
"""
    ...
    # Logika teks penyemangat (Menghitung dari buku riwayat)
